...
if file is not None:
    ...
    cv2.line(testImg,(lungMask['left'][0],lungMask['yMax']),(lungMask['right'][0],lungMask['yMax']),color, 2)
    ...
    cv2.putText(testImg,f'TD : {TD}',(TD//2,lungMask['yMax']-20),font,0.7,color,1,cv2.LINE_AA)
